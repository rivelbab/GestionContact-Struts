...
<body>
	<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
					<li class="nav-item active"><html:link styleClass="nav-link"
							...
							<span class="sr-only"><bean:message key="main.home" /></span>
						</html:link></li>
					<li class="nav-item"><a class="nav-link"
						href="ContactCreation.do"><b><bean:message
									key="main.addcontact" /></b> </a></li>
					<li class="nav-item"><a class="nav-link"
						href="ContactDisplay.do"><b><bean:message
									key="main.displaycontact" /></b></a></li>
				</ul>
				...
				<ul class="navbar-nav justify-content-end ml-auto">
					...
					<html:link
							...
							<b><bean:message key="main.logout" /></b>
					</html:link></li>
				</ul>
			</div>
		</nav>
				...
				<div class="col-md-10 offset m-2">
					<div class="card border-secondary">
						<div class="card-header text-center">
							<h1>
								<bean:message key="main.app.name" />
							</h1>
						</div>
							...
							<html:form action="/AddContact">
								<div class="card card-default">
										...
										<div class="row">
											<div class="col-sm-6">
												<div class="card card-default">
													<div class="card-header text-center">
														<h2>
															<bean:message key="form.contact" />
														</h2>
													</div>
													<div class="card-body mb-2">
														<div class="form-group">
															<label><bean:message key="form.id" /></label>
															<html:text property="id" styleClass="form-control" />
														</div>
														<div class="form-group">
															<label><bean:message key="form.firstname" /></label>
															<html:text property="firstName" styleClass="form-control" />
														</div>
														<div class="form-group">
															<label><bean:message key="form.lastname" /></label>
															<html:text property="lastName" styleClass="form-control" />
														</div>
														<div class="form-group">
															<label><bean:message key="form.email" /></label>
											...
											<div class="col-sm-6">
												<div class="card card-default">
													<div class="card-header text-center">
														<h2>
															<bean:message key="form.addr" />
														</h2>
													</div>
													<div class="card-body mb-2">
														<div class="form-group">
															<label><bean:message key="form.street" /></label>
															<html:text property="street" styleClass="form-control" />
														</div>
														<div class="form-group">
															<label><bean:message key="form.city" /></label>
															<html:text property="city" styleClass="form-control" />
														</div>
														<div class="form-group">
															<label><bean:message key="form.zip" /></label>
															<html:text property="zip" styleClass="form-control" />
														</div>
														<div class="form-group">
															<label><bean:message key="form.country" /></label>
									...
									<div class="card-footer text-center">
										<html:submit styleClass="mt-5 btn btn-primary btn-lg">
		...
		<div id="footer"
			...
			<bean:message key="main.app.name" />
			<b> &copy; Rivel</b> | <b> &copy; Mohamed</b> | <b> &copy;
				Aurelien</b> Miage 2018
		</div>
	</div>
</body>
</html:html>
